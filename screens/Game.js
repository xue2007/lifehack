        ...
        <Block flex>
          ...
          <Block space="between" style={styles.padded}>
            <Block>
              ...
              <Block >
                <Block>
                  <Text color="white" size={60}>Justatic</Text>
                </Block>
                <Block>
                  <Text color="white" size={60}>Covid-19</Text>
                </Block>
                <Block row>
                  <Text color="white" size={60}>Game</Text>
                  <Block middle style={styles.pro}>
                    <Text size={16} color="white">Lifehack</Text>
                  </Block>
                </Block>
              </Block>
              <Text size={16} color='rgba(255,255,255,0.6)' style={{ marginTop: 35 }}>
                Earn vouchers by taking part in quizzes, videos and educational news!
              </Text>
